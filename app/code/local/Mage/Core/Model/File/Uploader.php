...
class Mage_Core_Model_File_Uploader extends Varien_File_Uploader
{
    ...
    /**
     * PHP 7 compatibility rewrite
     *
     * Part of Inchoo_PHP7 extension. There was no other way to fix this :-(
     * Still, slightly more elegant than copying Varien_File_Uploader.
     *
     * @throws Exception
     */
